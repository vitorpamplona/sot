 ...
 * ranks profiles in Vespa (via :common-query) and returns the original signed
...
private val NIP11 =
    """{"name":"vespa-search","description":"NIP-50 profile search ranked by Nostr web-of-trust",""" +
        """"supported_nips":[1,11,42,50],"software":"https://github.com/vitorpamplona/vespa-search","version":"0.1"}"""
        ...
        routing {
            get("/") {
                if ((call.request.headers["Accept"] ?: "").contains("application/nostr+json")) {
                    ...
                    call.respondText("vespa-search relay — open a WebSocket and send a NIP-50 search REQ")
                }
            }
            webSocket("/") {

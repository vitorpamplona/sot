# **S**earch **o**ver **T**rust (SoT) — v1, FROZEN

> **This is the legacy implementation** (SQLite event store + a separate
> Vespa projection), kept only as the working reference until the rewrite at
> the repo root is validated against a real Vespa deployment and real relays.
> Modules build as `:v1:*` (e.g. `./gradlew :v1:cli:installDist`). No new work
> lands here; delete this folder once v2 is proven. See the root `README.md`.
